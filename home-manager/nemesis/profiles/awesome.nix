...
in {
  ...
  home.file.".xserverrc" = config.lib.remotefiles.symlink "self" "home-manager/${username}/files/xorg/.xserverrc";
  home.file.".xinitrc" = {
    executable = true;
    text =
      /*
  ...
  xdg.configFile."awesome" = config.lib.remotefiles.symlink "self" "home-manager/${username}/files/awesome/.config/awesome";
